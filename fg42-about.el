...
(defun about/get_string ()
  ...
  (let (msg)
    (setq msg (replace-regexp-in-string "%%VERSION%%" FG42-VERSION about_fg42_msg))
    )
)
...
(define-key-after global-map [menu-bar help-menu about-kuso] '("About FG42" . about-kuso-f) 'about-emacs)
